...
document.getElementById('r0-result').addEventListener('click', async() => {
    var L = document.getElementById('r0-L').value
    var dt = document.getElementById('r0-dt').value
    var d3 = document.getElementById('r0-d3').value
    var a3 = document.getElementById('r0-a3').value
...
document.getElementById('x0-result').addEventListener('click', async() => {
    var L = document.getElementById('x0-L').value
    var R0 = document.getElementById('x0-r0').value
    var a3 = document.getElementById('x0-a3').value
...
document.getElementById('y0-result').addEventListener('click', async() => {
    var R0 = document.getElementById('y0-r0').value
    var a3 = document.getElementById('y0-d3').value
    var d3 = document.getElementById('y0-d3').value
